...
It can be found under `<DOCUMENTS>/krateZ/scripts/`.
...
### Script Structure
The basic script structure consists of a class which provides certain properties that help krateZ to instantiate your script as needed.
