...
class ScriptExecutor10 extends IScriptExecutor {
	...
	async executeScript() {
		...
		if (blockReason > 0) {
			...
			console.error(`[krateZ] Blocked Script: ${this.#script.meta.name} by ${this.#script.meta.author}. Reason: ${[reasonMapping[blockReason - 1]]}`);
			return false;
		}

		console.log(`[krateZ] Executing userscript: ${this.#script.meta.name} by ${this.#script.meta.author}`);
	...
	async unloadScript() {
		...
		console.log(`[krateZ] Unloading userscript: ${this.#script.meta.name} by ${this.#script.meta.author}`);
		this.#script.unload();
		this.isLoaded = false;
		return true;
	}
